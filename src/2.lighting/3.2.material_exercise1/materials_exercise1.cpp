...
int main() {
    ...
    // 编译生成着色程序
    Shader lightingShader("3.2.materials.vert", "3.2.materials.frag");
    Shader lightCubeShader("3.2.light_cube.vert", "3.2.light_cube.frag");
...
//        lightPos.y = sin(currentTime / 2.0f) * 1.0f;
        ...
        // 材质属性设置
        lightingShader.setVec3("material.ambient", 0.1f, 0.1f, 0.06f);
