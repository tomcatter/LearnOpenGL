...
int main() {
    ...
    // 编译生成着色程序
    Shader lightingShader("5.2.light_casters.vert", "5.2.light_casters.frag");
    Shader lightCubeShader("5.2.light_cube.vert", "5.2.light_cube.frag");
