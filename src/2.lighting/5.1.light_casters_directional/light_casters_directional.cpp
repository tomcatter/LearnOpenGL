...
int main() {
    ...
    // 编译生成着色程序
    Shader lightingShader("5.1.light_casters.vert", "5.1.light_casters.frag");
    Shader lightCubeShader("5.1.light_cube.vert", "5.1.light_cube.frag");
    ...
    unsigned int specularMap = loadTexture(
            FileSystem::getPath(("resources/textures/container2_specular_colored.png")).c_str());
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setFloat("matrixmove", static_cast<float>(glfwGetTime()));
        lightingShader.setFloat("matrixlight", (1.0f + static_cast<float>(sin(glfwGetTime()))) / 2.0f + 0.5f);
        // 设置灯光属性
        glm::vec3 lightColor;
        ...
        lightingShader.setVec3("light.diffuse", 0.56f, 0.56f, 0.56f);
